...
en el pc son trabajadas en SQL.

Aquí seleccionamos y cambiamos los nombres de las columnas. Cambiamos el
tipo de dato caracter a Date a la fecha, y redondeamos el peso.
...
Cabe señalar info_1 tiene 33 filas mientras que info_2 tiene 67. Como
ninguna fila se repite, da una totalidad de 100 filas en la union.
...
Es decir, una vez procesado y limpiado Info_1 e Info_2, las unimos en su
totalidad. Abajo imagenes más esclarecedoras
...
las 00:00Horas, por lo tanto da resultado NA, por eso veremos un error
